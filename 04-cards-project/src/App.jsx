    ...
    <div className='parent'>
      {
        jobOpenings.map(function(elem, idx) {
          return <div key={idx}>
            <Card companyName={elem.companyName} brandLogo={elem.brandLogo} datePosted={elem.datePosted} post={elem.post} pay={elem.pay} location={elem.location} tag1={elem.tag1} tag2={elem.tag2}/>
          </div>
        })
      }
    </div>
